    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                similique incidunt illo quos harum consequatur temporibus est
                natus non facilis consectetur magnam sapiente velit eveniet, at
                officia dolorem. Nihil, rem.
              </p>
            </div>
          </div>
          <div>
        ...
        <div>
          ...
          <div className="p-3 shadow text-center mt-6">
          ...
          <div className="mb-10 space-y-5">
            <div className="flex justify-between">
              ...
              <div className="font-semibold">31 Jan 2024</div>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <div className="font-semibold">$100 - $1000 SGD</div>
            </div>
          </div>
          <Separator />

          <div className="my-10">
            <div className="text-3xl font-semibold mb-4">Require Skills</div>
